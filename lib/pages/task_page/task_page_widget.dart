            ...
            children: [
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      dateTimeFormat('d/M h:mm a', widget.task!.deadline!),
                    ...
                    Builder(
                      builder: (context) {
                        final usersRefs = widget.task?.usersRef.toList() ?? [];
                        return ListView.builder(
                          padding: EdgeInsets.zero,
                          shrinkWrap: true,
                          scrollDirection: Axis.vertical,
                          itemCount: usersRefs.length,
                          itemBuilder: (context, usersRefsIndex) {
                            final usersRefsItem = usersRefs[usersRefsIndex];
                            return Padding(
                              padding: const EdgeInsetsDirectional.fromSTEB(
                                  0.0, 12.0, 0.0, 0.0),
                              child: StreamBuilder<UsersRecord>(
                                stream: UsersRecord.getDocument(usersRefsItem),
              ...
              Padding(
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    _model.firstUser = await UsersRecord.getDocumentOnce(widget
                        .task!.usersRef
                        .where((e) => currentUserReference?.id != e.id)
                        .toList()
                        .first);
